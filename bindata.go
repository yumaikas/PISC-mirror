...
func stdlibDebugPisc() (*asset, error) {
	...
	info := bindataFileInfo{name: "stdlib/debug.pisc", size: 233, mode: os.FileMode(438), modTime: time.Unix(1493398664, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func stdlibStringsPisc() (*asset, error) {
	...
	info := bindataFileInfo{name: "stdlib/strings.pisc", size: 952, mode: os.FileMode(438), modTime: time.Unix(1493398664, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
