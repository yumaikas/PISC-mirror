...
func stdlibStd_libPisc() (*asset, error) {
	...
	info := bindataFileInfo{name: "stdlib/std_lib.pisc", size: 2033, mode: os.FileMode(438), modTime: time.Unix(1499018220, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func stdlibVectorsPisc() (*asset, error) {
	...
	info := bindataFileInfo{name: "stdlib/vectors.pisc", size: 1860, mode: os.FileMode(438), modTime: time.Unix(1499018220, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
