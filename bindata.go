...
func stdlibDictsPisc() (*asset, error) {
	...
	info := bindataFileInfo{name: "stdlib/dicts.pisc", size: 1125, mode: os.FileMode(384), modTime: time.Unix(1511936614, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func stdlibVectorsPisc() (*asset, error) {
	...
	info := bindataFileInfo{name: "stdlib/vectors.pisc", size: 1603, mode: os.FileMode(384), modTime: time.Unix(1511936614, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
