...
func stdlibStd_libPisc() (*asset, error) {
	...
	info := bindataFileInfo{name: "stdlib/std_lib.pisc", size: 2024, mode: os.FileMode(438), modTime: time.Unix(1505370568, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
