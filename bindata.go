...
func stdlibStd_libPisc() (*asset, error) {
	...
	info := bindataFileInfo{name: "stdlib/std_lib.pisc", size: 1686, mode: os.FileMode(438), modTime: time.Unix(1511558321, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
